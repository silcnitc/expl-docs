...
_Syntax_ : BRKP
_Semantics_ : The machine when run in [debug mode](xsmusagespec.md#nav-debug) invokes the debugger when this intruction is executed. This instruction can be used for debugging system code.
