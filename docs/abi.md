...
The following sections specify the ABI for the [eXpOS operating system](http://exposnitc.github.io/) run on the [XSM virtual machine model](http://exposnitc.github.io/virtual_machine_spec.html). The executable format is called the XEXE executable format.
...
<tr>
<td rowspan="2">Direct Addressing</td> <td>MOV [LOC], Rj</td> <td>Copy contents of Rj to the memory address LOC</td> </tr>
<tr>
<td>MOV Rj, [LOC]</td> <td>Copy contents of the memory location LOC to the register Rj</td> </tr>
</tbody>
</table>
</div>
</div>
