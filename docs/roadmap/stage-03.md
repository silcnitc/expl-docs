...
There is one important conceptual point to understand here before proceeding to the front end 
...
At the leaf nodes of the tree, since you have either constants or variables, the type must be
