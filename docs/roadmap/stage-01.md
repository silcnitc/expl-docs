...
!!! question "Exercise 1"
    ...
    !!! note
        You would have already completed this task if you have done the [Using Yacc With Lex tutorial](ywl.html)
...
!!! note
    ...
    Please follow instructions in the [XSM environment tutorial](xsm-environment-tut.html).
